...
serv = pfw_windows.system.services[0]
print("    " + str(serv))
...
serv = [s for s in pfw_windows.system.services if s.process][0]
print("    " + str(serv))
print((" " * 8) + "name = {0}".format(serv.name))
print((" " * 8) + "description = {0}".format(serv.description))
print((" " * 8) + "status = {0}".format(serv.status))
...
cp_handles = [h for h in system.handles if h.dwProcessId == pfw_windows.current_process.pid]
...
kmod = pfw_windows.system.modules[0]
print("    " + str(kmod))
