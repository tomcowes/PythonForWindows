...
from pfw_windows.generated_def import RPC_C_IMP_LEVEL_IMPERSONATE, CLSCTX_INPROC_SERVER
from pfw_windows.generated_def import interfaces
from pfw_windows.generated_def.interfaces import generate_IID, IID

from pfw_windows.pycompat import int_types, basestring

# We have    pfw_windows.com.COMImplementation
# So we need pfw_windows.com.COMInterface
