...
from pfw_windows.crypto import DEFAULT_ENCODING, CertificateStore
...
def generate_selfsigned_certificate(name="CN=DEFAULT", prov=None, key_info=None, flags=0, signature_algo=None):
    ...
    :return: :class:`pfw_windows.crypto.Certificate`
    """
    ...
    return pfw_windows.crypto.Certificate.from_pointer(cert)
