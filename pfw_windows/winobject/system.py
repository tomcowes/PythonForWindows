...
from pfw_windows.winobject import process
from pfw_windows.winobject import network
from pfw_windows.winobject import registry
from pfw_windows.winobject import exception
from pfw_windows.winobject import service
from pfw_windows.winobject import volume
from pfw_windows.winobject import wmi
from pfw_windows.winobject import object_manager
from pfw_windows.winobject import device_manager
from pfw_windows.winobject import handle
from pfw_windows.winobject import event_log
from pfw_windows.winobject import event_trace
from pfw_windows.winobject import task_scheduler
from pfw_windows.winobject import system_module
from pfw_windows.winobject import bits
...
class UnicodeEnvironment(dict):
    ...
    def __delitem__(self, key):
        key = key.upper()
        pfw_windows.winproxy.SetEnvironmentVariableW(key, None)
    ...
    def __setitem__(self, key, value):
        if value is None:
            ...
            return
        key = key.upper()
        pfw_windows.winproxy.SetEnvironmentVariableW(key, value)
...
class System(object):
    ...
    """Object of class :class:`pfw_windows.winobject.network.Network`"""
    registry = registry.Registry()
    """Object of class :class:`pfw_windows.winobject.registry.Registry`"""

    @property
    def processes(self):
        """The list of running processes

        :type: [:class:`~pfw_windows.winobject.process.WinProcess`] -- A list of Process
		"""
    ...
    def threads(self):
        ...
        :type: [:class:`~pfw_windows.winobject.process.WinThread`] -- A list of Thread
		"""
    ...
    def logicaldrives(self):
        ...
        :type: [:class:`~pfw_windows.winobject.volume.LogicalDrive`] -- A list of LogicalDrive
        """
    ...
    def services(self):
        ...
        :type: :class:`~pfw_windows.winobject.service.ServiceManager`
        """
    ...
    def handles(self):
        ...
        :type: [:class:`~pfw_windows.winobject.handle.Handle`] -- A list of Hanlde"""
    ...
    def modules(self):
        ...
        :type: [:class:`~pfw_windows.winobject.system_module.SystemModule`] -- A list of :class:`~pfw_windows.winobject.system_module.SystemModule` or :class:`~pfw_windows.winobject.system_module.SystemModuleWow64`
        """
    ...
    def _create_unicode_environ_dict(self):
        rawdictenv = {}
        curenv = envptr = pfw_windows.winproxy.GetEnvironmentStringsW()
        while True:
        ...
        pfw_windows.winproxy.FreeEnvironmentStringsW(envptr)
    ...
    def wmi(self):
        ...
        :type: :class:`~pfw_windows.winobject.wmi.WmiManager`"""
    ...
    def event_log(self):
        ...
        :type: :class:`~pfw_windows.winobject.event_log.EvtlogManager`
        """
    ...
    def etw(self):
        ...
        :type: :class:`~pfw_windows.winobject.event_trace.EtwManager`
        """
    ...
    def task_scheduler(self):
        ...
        :type: :class:`~pfw_windows.winobject.task_scheduler.TaskService`
        """
        ...
        pfw_windows.com.create_instance(clsid_task_scheduler, task_service)
    ...
    def object_manager(self):
        ...
        :type: :class:`~pfw_windows.winobject.object_manager.ObjectManager`
        """
        return pfw_windows.winobject.object_manager.ObjectManager()

    @utils.fixedpropety
    def device_manager(self):
        """An object to query the device&driver configured on the computer.

        :type: :class:`~pfw_windows.winobject.device_manager.DeviceManager`
        """
        return pfw_windows.winobject.device_manager.DeviceManager()
    ...
    def build_number(self):
        ...
        try:
            ...
            curver_key = pfw_windows.system.registry(r"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion")
            try:
