...
from pfw_windows.com import interfaces as cominterfaces
from pfw_windows.generated_def.winstructs import *
from pfw_windows.generated_def.windef import *
...
def get_MIB_TCPTABLE_OWNER_PID_from_buffer(buffer):
    x = pfw_windows.generated_def.winstructs.MIB_TCPTABLE_OWNER_PID.from_buffer(buffer)
...
def get_MIB_TCP6TABLE_OWNER_PID_from_buffer(buffer):
    x = pfw_windows.generated_def.winstructs.MIB_TCP6TABLE_OWNER_PID.from_buffer(buffer)
    nb_entry = x.dwNumEntries
...
class Network(object):
    NetFwPolicy2 = pfw_windows.com.IID.from_string("E2B3C97F-6AE1-41AC-817A-F6F92166D7DD")
    ...
    def firewall(self):
        ...
        firewall = Firewall()
        pfw_windows.com.create_instance(self.NetFwPolicy2, firewall)
        return firewall
