...
class KernelObject(object):
    ...
    def items(self):
        ...
        .. note::
            ...
            it will raise :class:`~pfw_windows.generated_def.ntstatus.NtStatusException` with
            code :data:`~pfw_windows.generated_def.STATUS_OBJECT_TYPE_MISMATCH`
        """
        path = self.fullname
...
class ObjectManager(object):
    ...
    .. note::
        ...
        from ``pfw_windows.system`` just like other API and not directly the ``root`` directory.
    """
