...
from pfw_windows.utils import fixedproperty
...
class DeviceInstance(gdef.SP_DEVINFO_DATA):
    ...
    def get_property(self, property):
        datatype = gdef.DWORD()
        buffer_size = 0x1000
        buffer = pfw_windows.utils.BUFFER(gdef.BYTE, nbelt=buffer_size)()
        ...
        return pfw_windows.winobject.registry.decode_registry_buffer(datatype.value, buffer, required_size.value)
