...
from pfw_windows.utils import AutoHandle
...
class LogicalDrive(AutoHandle):
    ...
    def query_info(self, info):
        return pfw_windows.utils.query_volume_information(self.handle, info)
    ...
    def _get_handle(self):
        nt_name = pfw_windows.utils.dospath_to_ntpath(self.name)
        handle = pfw_windows.winproxy.CreateFileA(nt_name, gdef.GENERIC_READ,
