...
from pfw_windows.com import COMImplementation
from  pfw_windows.generated_def.interfaces import (IBackgroundCopyManager, IEnumBackgroundCopyJobs, IBackgroundCopyJob,
                                                IBackgroundCopyCallback, IUnknown, IBackgroundCopyError, IEnumBackgroundCopyFiles,
                                                IBackgroundCopyFile)
import pfw_windows.generated_def as gdef

BackgroundCopyManager = pfw_windows.com.IID.from_string("4991d34b-80a1-4291-83b6-3328366b9097")
BackgroundCopyManager1_5 = pfw_windows.com.IID.from_string("f087771f-d74f-4c1a-bb8a-e16aca9124ea")
BackgroundCopyManager2_0 = pfw_windows.com.IID.from_string("6d18ad12-bde3-4393-b311-099c346e6df9s")
BackgroundCopyManager2_5 = pfw_windows.com.IID.from_string("03ca98d6-ff5d-49b8-abc6-03dd84127020")
BackgroundCopyManager3_0 = pfw_windows.com.IID.from_string("659cdea7-489e-11d9-a9cd-000d56965251")
...
class BitsCopyManager(IBackgroundCopyManager):
    ...
    def create(self, name, jobtype):
        myjob_uuid = pfw_windows.com.IID()
        newjob = BitsCopyJob()
...
class BitsCopyJob(IBackgroundCopyJob):
    ...
    def owner(self):
        ...
        self.GetOwner(owner)
        data = owner.value
        pfw_windows.winproxy.CoTaskMemFree(owner)
        return data


    @property
    def iid(self):
        res = pfw_windows.com.IID()
        self.GetId(res)
        res.update_strid()
        return res
    ...
    def name(self):
        ...
        data = descr.value
        pfw_windows.winproxy.CoTaskMemFree(descr)
        return data
    ...
    def proxy_settings(self):
        ...
        pfw_windows.winproxy.CoTaskMemFree(ProxyList)
        pfw_windows.winproxy.CoTaskMemFree(ProxyBypassList)
        return result
...
class BitsCopyJob2(gdef.IBackgroundCopyJob2, BitsCopyJob):
    ...
    def notify_cmdline(self):
        ...
        pfw_windows.winproxy.CoTaskMemFree(path)
        pfw_windows.winproxy.CoTaskMemFree(params)
...
class BitsFile(IBackgroundCopyFile):
    ...
    def local_name(self):
        ...
        data = name.value
        pfw_windows.winproxy.CoTaskMemFree(name)
        return data
...
def create_manager(version=(3,0)):
    ...
    pfw_windows.com.create_instance(clsid, manager)
    return manager