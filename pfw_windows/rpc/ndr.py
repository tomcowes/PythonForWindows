...
class NdrSID(object):
    ...
    def pack(cls, psid):
        ...
        :param PSID psid:
        """
        subcount = pfw_windows.winproxy.GetSidSubAuthorityCount(psid)
        size = pfw_windows.winproxy.GetLengthSid(psid)
        sid_data = pfw_windows.current_process.read_memory(psid.value, size)
