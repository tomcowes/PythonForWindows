...
def test_services_process():
    services_with_process = [s for s in pfw_windows.system.services if s.status.dwProcessId]
...
def test_service_appinfo():
    appinfo = pfw_windows.system.services["Appinfo"]
...
def test_service_start():
    faxservice = pfw_windows.system.services["Fax"]
